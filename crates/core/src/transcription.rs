...
pub struct TranscriptSegment {
    ...
    /// Display name from voice bank (Alice, Guest-1) when person_id is set.
    /// Computed via JOIN with persons table; not stored in transcript_segments.
    #[serde(default, skip_serializing_if = "Option::is_none")]
        ...
        if let Some(segments) = &resp.segments {
            for seg in segments {
                all_segments.push(TranscriptSegment {
                    ...
                    text: seg.text.clone(),
                    timestamp: Some(format_timestamp_readable(offset + seg.start)),
        ...
        let chunk1 = TranscriptionResponse {
            ...
            segments: Some(vec![
                ...
                TranscriptSegment {
                    ...
                    timestamp: Some(format_timestamp_readable(10.0)),
                    tokens: None,
                    temperature: None,
                    avg_logprob: None,
                    compression_ratio: None,
        ...
        let chunk2 = TranscriptionResponse {
            ...
            segments: Some(vec![
                ...
                TranscriptSegment {
                    ...
                    timestamp: Some(format_timestamp_readable(5.0)),
                    tokens: None,
                    temperature: None,
                    avg_logprob: None,
                    compression_ratio: None,
